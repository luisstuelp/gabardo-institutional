...
import { MessageCircle, Calendar, User, ListFilter, Mail, Phone } from 'lucide-react';
...
export default function AdminContactsPage() {
    ...
    // Filter only contact page submissions
    const contactLeads = leads?.filter(lead => lead.source === 'contact_page') || [];
    ...
    const handleWhatsApp = (phone: string, message: string | null) => {
        ...
        const text = message ? `Olá, sobre sua mensagem em nosso site: "${message}"` : 'Olá, recebemos seu contato pelo site.';
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold font-montserrat text-primary">Contatos do Site</h1>
                                ...
                                <Badge variant="secondary" className="ml-1 h-5 px-1.5 text-[10px]">
                                    {statusFilter === 'new' ? 'Novos' :
                                        statusFilter === 'contacted' ? 'Em Contato' :
                                            statusFilter === 'closed' ? 'Resolvidos' : statusFilter}
                                </Badge>
                            )}
                        </Button>
                    </DropdownMenuTrigger>
                ...
                <Table>
                    ...
                    <TableBody>
                        {isLoading ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={6} className="h-24 text-center text-muted-foreground">Nenhuma mensagem encontrada.</TableCell>
                            </TableRow>
                        ) : (
                                    ...
                                    <TableCell>
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="lost">Arquivado</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </TableCell>
