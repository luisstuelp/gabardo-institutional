...
export interface BlogContent {
  type: 'paragraph' | 'heading' | 'quote' | 'image' | 'list' | 'divider' | 'highlight' | 'video';
  content: string;
...
export const blogPosts: BlogPost[] = [
  {
    ...
    slug: 'bndes-gabardo',
    title: 'BNDES Gabardo',
    excerpt: 'Em um ano desafiador, a parceria estratégica entre Gabardo e BNDES acelerou a retomada após as enchentes de 2024 e impulsionou novos investimentos em infraestrutura sustentável.',
    content: [
      {
        type: 'paragraph',
        content: '2024 exigiu resiliência máxima da Gabardo. Após as enchentes de maio, reorganizamos operações, cuidamos das pessoas e mantivemos clientes informados enquanto buscávamos formas de acelerar a retomada com responsabilidade.'
      },
      {
        type: 'video',
      ...
      {
        type: 'paragraph',
        content: 'A parceria com o BNDES foi decisiva para garantir liquidez e planejar investimentos de longo prazo. As linhas de crédito habilitaram modernização de frota, reforço da infraestrutura logística e aceleração de programas de sustentabilidade.'
      },
      {
        type: 'list',
      ...
      {
        type: 'highlight',
        content: 'Com apoio do BNDES, transformamos um período adverso em plataforma de crescimento sustentável, reforçando nosso compromisso de transportar com coragem, inovação e respeito ao meio ambiente.'
      }
    ],
    ...
    seo: {
      description: 'Confira como a parceria entre BNDES e Gabardo acelerou a retomada pós-enchente e fortaleceu investimentos sustentáveis na operação logística.',
      keywords: ['BNDES', 'Gabardo', 'investimentos sustentáveis', 'logística automotiva']
    }
  },
  {
    id: '10',
