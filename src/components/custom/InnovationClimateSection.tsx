...
export default function InnovationClimateSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#f3f7ff] via-white to-[#e9f3ff] py-20 md:py-24">
      <motion.div
        aria-hidden
        initial={{ opacity: 0 }}
      ...
      >
        <div className="absolute -left-24 top-10 h-72 w-72 rounded-full bg-gabardo-blue/12 blur-3xl" />
        <div className="absolute right-16 bottom-8 h-64 w-64 rounded-full bg-emerald-300/35 blur-3xl" />
      </motion.div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-gabardo-blue">
              Dados e tecnologia para acelerar o carbono negativo
            </h2>
          ...
          >
            ...
            <figcaption className="absolute bottom-4 left-4 right-4 rounded-2xl bg-white/85 px-4 py-2 text-xs font-semibold uppercase tracking-[0.26em] text-gabardo-blue">
              Torre de controle digital Gabardo
            </figcaption>
          </motion.figure>
        </div>
      </div>
