      ...
      <div className="absolute inset-0">
        {backgroundImages.map((img, index) => (
          ...
          >
            <Image
              src={img}
              alt="Gabardo - Transporte de Veículos"
              fill
        ...
        <div className="flex flex-col justify-end h-full pb-8 md:pb-0">
          <div className="flex items-end w-full">
            ...
            <div className="flex-grow max-w-full md:max-w-4xl xl:max-w-5xl">
              ...
              >
                Desde 1989, a Gabardo carrega o legado de Sérgio Mário Gabardo, 
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  <Dot className="w-3 h-3 text-gabardo-light-blue flex-shrink-0" />
                  <span className="text-xs sm:text-sm font-light tracking-wide">1.4M+ Veículos transportados</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Dot className="w-3 h-3 text-gabardo-light-blue flex-shrink-0" />
